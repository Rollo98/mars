...
const { db } = require('../config.local/config.local')

const GCP_VM_DATA = db.define(
  'gcp_vm_data',
  {
...
const GCP_LICENSE_DATA = db.define(
  'gcp_license_data',
  {
    // Model attributes are defined here
    instance_id: {
...
const GCP_PROJECT_DATA = db.define(
  'gcp_project_data',
  {
    // Model attributes are defined here
    project_id: {
...
// export modules to be imported by LogWritter
